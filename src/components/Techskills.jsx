...
function ActiveDirectoryIcon() {
  return (
    <div>
      <FaUsers size={64} className=' mx-2'/>
      <p className='flex flex-wrap  my-2 mb-0 items-center justify-center'>AD</p>
    </div>
  );
}
...
function SQLIcon() {
    return (
      <div>
        <FaDatabase size={64} className=' mx-2'/>
        <p className='flex flex-wrap  my-2 mb-0 items-center justify-center'>SQL</p>
      </div>
    );
  }
  function PythonIcon() {
  ...
  function Powershell() {
    return (
      <div>
        <SiPowershell size={64} className=' mx-2' />
        <p className='flex flex-wrap  my-2 mb-0 items-center justify-center '>Powershell</p>
      </div>
    );
  }
    ...
    <div className=' border-b border-neutral-900  pb-24'>
        ...
        <motion.div whileInView={ {opacity: 1 , x:0}} initial={{opacity: 0 , x: -100}} transition={{duration: 0.5}} className=' flex flex-wrap  items-center justify-center gap-4 '>
            ...
            <motion.div variants={iconVariants(2)} initial="initial" animate="animate" className=' rounded-2xl border-4 border-neutral-800 p-4 '>
                <Powershell className=' text-7xl text-white-400'/>
            </motion.div>
            <motion.div variants={iconVariants(6)} initial="initial" animate="animate" className=' rounded-2xl border-4 border-neutral-800 p-4 '>
                <PythonIcon className=' text-7xl text-white-400'/>
            </motion.div>
            <motion.div variants={iconVariants(2)} initial="initial" animate="animate" className=' rounded-2xl border-4 border-neutral-800 p-4 '>
                <SQLIcon className=' text-7xl text-white-400'/>
            </motion.div>
            <motion.div variants={iconVariants(5)} initial="initial" animate="animate" className=' rounded-2xl border-4 border-neutral-800 p-4 '>
                <ActiveDirectoryIcon className=' text-7xl text-white-400'/>
            </motion.div>
